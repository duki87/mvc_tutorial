  ...
  <div class="card col-md-6 mx-auto">
    ...
    <div class="card-body">
      ...
      <form class="form" action="<?=SITE_ROOT;?>register/login" method="post">
        <?=FH::csrfInput();?>
        <?=FH::inputBlock('text', 'Username', 'username', $this->newUser->username, ['srOnly' => 'false', 'class' => 'form-control'], ['class' => 'form-group']);?>
        <?=FH::inputBlock('password', 'Password', 'password', $this->newUser->password, ['srOnly' => 'false', 'class' => 'form-control'], ['class' => 'form-group']);?>
