...
<form class="" action="<?=$this->postAction;?>" method="post">
  ...
  <div class="row">
    ...
    <?=FH::inputBlock('hidden', '', 'deleted', $this->post['deleted'], ['srOnly' => 'false', 'class' => ''], ['class' => 'd-none']);?>
    ...
    <?=FH::submitBlock('Edit Contact', ['class' => 'btn btn-success'], ['class' => 'form-group col-md-4']);?>
  </div>
</form>
